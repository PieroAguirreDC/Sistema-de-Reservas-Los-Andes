...
locals {
  services = {
    usuarios       = aws_ecs_service.usuarios.name
    habitaciones   = aws_ecs_service.habitaciones.name
    reservas       = aws_ecs_service.reservas.name
    pagos          = aws_ecs_service.pagos.name
    notificaciones = aws_ecs_service.notificaciones.name
